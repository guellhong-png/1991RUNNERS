      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="w-full py-3 bg-[#c0392b] hover:bg-[#a93226] text-white font-medium rounded-lg transition-colors disabled:opacity-50">{loading ? '로그인 중...' : '로그인'}</button>
          </form>
          <p className="text-center text-sm text-gray-500 mt-4">
            계정이 없으신가요?{' '}
            <Link href="/register" className="text-[#c0392b] font-medium hover:underline">가입 신청</Link>
          </p>
        </div>
      </div>
    </div>
