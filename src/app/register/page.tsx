      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full py-3 disabled:opacity-50">{loading ? '신청 중...' : '가입 신청'}</button>
          </form>
          <p className="text-center text-sm text-gray-500 mt-4">
            이미 계정이 있으신가요?{' '}
            <Link href="/login" className="text-[#e94560] font-medium hover:underline">로그인</Link>
          </p>
        </div>
      </div>
    </div>
