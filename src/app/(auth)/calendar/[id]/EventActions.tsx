...
export default function EventActions({ event, currentUserId, currentUserRole, initialComments, canEdit }: Props) {
  ...
  const handleCommentSubmit = async () => {
    ...
    const { data } = await supabase
      .from('event_comments')
      .insert({ event_id: event.id, author_id: currentUserId, content: newComment.trim() })
