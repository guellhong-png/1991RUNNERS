      ...
      <div className="card">
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input value={form.title} placeholder="연도 또는 제목" onChange={(e) => setForm({ ...form, title: e.target.value })} className="input" required />
          </div>
          <div>
              ...
              <div className="mt-3 space-y-2">
                {attachments.map((att, i) => (
                  <div key={i} className={`flex items-center gap-3 p-3 rounded-lg border ${
                    ...
                    att.status === 'done' ? 'bg-green-50 border-green-100' :
