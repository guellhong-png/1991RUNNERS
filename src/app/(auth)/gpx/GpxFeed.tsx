            ...
            return (
              <div key={route.id} className="card">
                ...
                <div className="grid grid-cols-4 gap-2 mb-3">
                  ...
                  {route.duration != null && (
                    <div>
                      <p className="text-base font-bold text-gray-900">{formatDuration(route.duration)}</p>
                      <p className="text-xs text-gray-400">시간</p>
                    </div>
                  )}
                  {route.avg_pace != null && (
                    <div>
                      <p className="text-base font-bold text-gray-900">{formatPace(route.avg_pace)}</p>
